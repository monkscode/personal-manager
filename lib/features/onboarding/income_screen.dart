      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.currency_rupee_rounded, size: 30, color: AppColors.teal),
          ),
          const SizedBox(height: 24),
          Text('Your income & balance', style: jakarta(size: 24, weight: FontWeight.w800, height: 1.3, color: p.textPrimary)),
          const SizedBox(height: 8),
          Text("So we can tell you exactly if you'll be short, or have room to spare.",
              style: jakarta(size: 14, weight: FontWeight.w500, height: 1.6, color: p.textSecondary)),
          const SizedBox(height: 24),
          const FieldLabel('Monthly take-home salary (₹)'),
          AppTextField(controller: _salary, hint: '85000', mono: true, number: true, onChanged: ctrl.setSalary),
          const SizedBox(height: 16),
          const FieldLabel('Current bank balance (₹)'),
          AppTextField(controller: _balance, hint: '38000', mono: true, number: true, onChanged: ctrl.setCurrentBalance),
          const Spacer(),
